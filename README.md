...
```bash
npx @your-npm-username/throughline            # observe the current directory
npx @your-npm-username/throughline ../my-app  # observe a specific project
```

Or install it globally:

```bash
npm install -g @your-npm-username/throughline
